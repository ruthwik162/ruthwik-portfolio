...
const Image = () => {
    ...
    return (
        <div className=' h-full relative flex flex-col   justify-center items-center'>
            {/* Main Image */}
            <div ref={imgWrapperRef} className='image md:w-[30vw] lg:w-[28vw] xl:w-[20vw] sm:w-[45vw]  w-[65vw] mt-[5vh] md:mt-[10vh] lg:mt-[5vh] xl:mt-[10vh] z-4 rounded-2xl relative overflow-hidden' >
                <div className=''>
                    <img
                        src="/Ruthwik Profile.jpg"
                        alt=""
