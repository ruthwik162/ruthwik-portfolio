    ...
    <div className='w-full min-h-screen'>
      ...
      <section className='w-full  min-h-screen'>
        <div className='flex items-start  mt-[15vh] md:mt-[0] justify-center '>
          {/* rightside */}
          <div className='w-full h-full mx-[2vw] md:mx-[5vw] md:mt-[7vw] overflow-hidden'>
            <div className='overflow-hidden'>
              <h1 className='text-[7vw] tracking-tight md:text-[3vw] text-black font-poppins font-poppins-500 md:leading-[5vw] text-start'>Skills <span className='text-gray-400'>&</span> Expertice</h1>
              <p className='text-[3vw] md:text-[1vw] md:max-w-xl font-poppins font-poppins-300 md:leading-[1vw] '>Design, development, and strategy—crafted to bring ideas to life and make every interaction meaningful.</p>
            </div>

            <div className='overflow-hidden mt-[5vw] '>
              <div className='text-[4vw] md:text-[3vw] font-[aeonik1]'>
                <h1>Expertise</h1>
              </div>
              <div className='overflow-hidden  p-2'>
                {expert.map((exp, i) => (
                  <div key={i} className='flex items-center font-[aeonik1] border-b space-y-3 border-gray-200 md:text-[1.2vw] justify-between '>
                    ...
                    <span className='flex items-center justify-start text-[4vw] md:text-[1.6vw]'><span className='text-[3vw] md:text-[1vw]'> [{i + 1}] &nbsp; </span> {exp.name}</span>
                    <span className='text-[2.8vw] md:text-[1vw]'>{exp.desc}</span>
                  </div>
                ))}
              ...
              <div className='overflow-hidden  p-2'>
                {skill.map((exp, i) => (
                  <div key={i} className='flex items-center font-[aeonik1] border-b space-y-3 border-gray-200 md:text-[1.2vw] justify-between '>
                    ...
                    <span className='flex items-center text-[4vw] font-[aeonik1] md:font-[aeonik2] justify-start md:text-[2.5vw]'><span className='text-[3vw] md:text-[1vw]'> [{i + 1}] &nbsp; </span> {exp.name}</span>
                    <span className='md:text-[1.2vw] text-[2.5vw]' >{exp.desc}</span>
                  </div>
                ))}
          ...
          {/* left side */}
          <div className='w-2/3 md:block hidden h-full bg-black'>
      ...
      <div className='overflow-hidden md:mt-[15vh]'>
      ...
      <section className='w-full  min-h-screen'>
        <div className='flex items-start  mt-[15vh] md:mt-[5vw] justify-center '>
          ...
          <div className='w-full h-full mx-[2vw] md:mx-[5vw]  overflow-hidden'>
            <div className='overflow-hidden mt-[5vw] md:mt-0 '>
              <Architecture />
            </div>
          </div>
        </div>
