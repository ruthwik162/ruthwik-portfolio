        ...
        <div className="w-full min-h-screen  relative overflow-x-hidden">
            ...
            <section className="w-full md:px-10 flex flex-col items-center justify-center h-screen">
                <div className="leading-[2vw] font-poppins font-poppins-500 overflow-hidden text-center">
                    <h1 className="md:text-[7vw] text-[11vw] text-start uppercase tracking-tighter md:leading-[9vw] leading-[10vw] text-gray-300">
                ...
                <div className="overflow-hidden relative  w-[60%] lg:w-[30%] xl:w-[20%] xl:h-[3vw] h-[12vw] lg:h-[6vw] mt-5 flex items-center justify-center border-b-black   rounded-full border">
                    ...
                    >
                        ...
                        View Projects <span className="border p-2 text-white bg-black rounded-sm"><IoSparklesSharp /></span>
                    </button>
                </div>
